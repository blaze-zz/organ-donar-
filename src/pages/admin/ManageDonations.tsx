...
export default function ManageDonations() {
  ...
  const fetchData = async () => {
    try {
      const [donationsRes, doctorsRes] = await Promise.all([
        supabase.from('organ_donations').select('*').order('created_at', { ascending: false }),
  ...
  const handleAssign = (donation: DonationData) => {
    setSelectedDonation(donation);
    setSelectedDoctor(donation.assigned_doctor_id || '');
  ...
  const handleSaveAssignment = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: 'The organ donation has been updated successfully.',
      });
  ...
  return (
    <DashboardLayout navItems={navItems} title="Admin Panel">
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-display font-bold text-foreground">Organ Donations</h1>
          <p className="text-muted-foreground mt-1">Manage organ donations and assign collection doctors</p>
        </div>

        <Card>
          <CardHeader>
            <CardTitle>All Donations</CardTitle>
            <CardDescription>Review and manage organ donation submissions</CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
        ...
        <Dialog open={assignDialogOpen} onOpenChange={setAssignDialogOpen}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Update status and assign a collection doctor
              </DialogDescription>
            </DialogHeader>
            {selectedDonation && (
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label>Assign Collection Doctor</Label>
